...
<h3 class="text-3xl font-medium text-gray-700">Tableau de board</h3>
            ...
            <div
                ...
                <table class="min-w-full">
                    ...
                    <tbody id="listeLivreur" class="bg-white">
                        ...
                        <tr data-title="{{$livreur->nom_societe}} {{$livreur->servicename1}} {{$livreur->servicename2}} {{$livreur->servicename3}} {{$livreur->localisation}}">
