...
<h3 class="text-3xl font-medium text-gray-700">Demande de certification</h3>
        ...
        <div class="flex flex-wrap -mx-6">
            ...
            <div class="w-full px-6 mt-6 sm:w-1/2 xl:w-1/2 sm:mt-0">
                <div class="flex items-center px-5 py-6 bg-white rounded-md shadow-sm">
                    ...
                    <div class="mx-5">
                        <h4 class="text-2xl font-semibold text-gray-700">{{count($livreurs)}}</h4>
                        <div class="text-gray-500">sociétées ouvert aujourd'hui</div>
                    </div>
                </div>
            </div>
                ...
                <table class="min-w-full">
                    ...
                    <tbody class="bg-white">
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                <div class="text-sm leading-5 text-gray-900">{{$livreur->servicename1}}</div>
                                <div class="text-sm leading-5 text-gray-900">{{$livreur->servicename2}}</div>
                                <div class="text-sm leading-5 text-gray-900">{{$livreur->servicename3}}</div>
                            </td>
                            ...
                            <td
                                ...
                                <form action="{{route('livreurs.destroy', $livreur->id)}}" method="post" onclick="confirm('êtes voous sur de vouloir supprimer cette société de livraison ?')">
                                    @csrf
                                    @method('DELETE')
